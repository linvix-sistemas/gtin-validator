 ...
 *  */
export function isString(productCode: any, returnBooleanOrThrowError: "boolean" | "error" = "boolean"): boolean {
    if (productCode === "") {
 ...
 */
export function isStringOfDigits(productCode: string, returnBooleanOrThrowError: "boolean" | "error" = "boolean") {
...
export function randomGtinType(): "GTIN-8" | "GTIN-12" | "GTIN-13" | "GTIN-14" {
    const gtinTypeArray: ["GTIN-8", "GTIN-12", "GTIN-13", "GTIN-14"] = ["GTIN-8", "GTIN-12", "GTIN-13", "GTIN-14"];
